        ...
        protected void onPostExecute(Void result) {
            try {
                if (outputFile != null) {
                    ...
                    ContextThemeWrapper ctw = new ContextThemeWrapper( context, R.style.Theme_MaterialComponents_Light_Dialog_Alert);
                    ...
                    alertDialogBuilder.setNegativeButton("Buka File",new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            File pdfFile = new File(Environment.getExternalStorageDirectory() + "/CAKEP/" + downloadFileName);  // -> filename = maven.pdf
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                if (new CheckForSDCard().isSDCardPresent()) {
                    ...
                    apkStorage = new File(Environment.getExternalStorageDirectory() + "/" + "CAKEP");
                } else
